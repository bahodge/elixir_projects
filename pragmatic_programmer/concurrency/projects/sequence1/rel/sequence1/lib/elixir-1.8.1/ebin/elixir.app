    ...
    [{description,"elixir"},
     ...
     {modules,
         ['Elixir.Access','Elixir.Agent.Server','Elixir.Agent',
          ...
          'Elixir.CompileError','Elixir.CondClauseError','Elixir.Date.Range',
          'Elixir.Date','Elixir.DateTime','Elixir.Dict',
          ...
          'Elixir.IO.ANSI.Sequence','Elixir.IO.ANSI','Elixir.IO.Stream',
          'Elixir.IO.StreamError','Elixir.IO','Elixir.Inspect.Algebra',
          'Elixir.Inspect.Any','Elixir.Inspect.Atom',
          'Elixir.Inspect.BitString','Elixir.Inspect.Date.Range',
          'Elixir.Inspect.Date','Elixir.Inspect.DateTime',
          ...
          'Elixir.Inspect.Tuple','Elixir.Inspect.Version.Requirement',
          'Elixir.Inspect.Version','Elixir.Inspect','Elixir.Integer',
          ...
          'Elixir.Kernel.Typespec','Elixir.Kernel.Utils','Elixir.Kernel',
          'Elixir.KeyError','Elixir.Keyword','Elixir.List.Chars.Atom',
          ...
          'Elixir.OptionParser.ParseError','Elixir.OptionParser',
          ...
          'Elixir.String.Casing','Elixir.String.Chars.Atom',
          ...
          'Elixir.String.Chars.URI','Elixir.String.Chars.Version.Requirement',
          'Elixir.String.Chars.Version','Elixir.String.Chars',
          'Elixir.String.Tokenizer','Elixir.String.Unicode','Elixir.String',
          'Elixir.StringIO','Elixir.Supervisor.Default',
          'Elixir.Supervisor.Spec','Elixir.Supervisor','Elixir.SyntaxError',
          'Elixir.System','Elixir.SystemLimitError','Elixir.Task.Supervised',
